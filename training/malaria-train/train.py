#!/usr/bin/env python3
"""
Malaria Training Script
Train malaria classifier for blood cell images
"""
...
class BloodCellDataset(torch.utils.data.Dataset):
    """Dataset for malaria blood cell classification"""
...
class MalariaTrainer:
    """Trainer for malaria classifier"""
    ...
    def fit(self, train_loader: DataLoader, val_loader: DataLoader):
        ...
        for epoch in range(self.config.num_epochs):
            ...
            if val_metrics['accuracy'] > best_val_acc:
                ...
                model_path = Path(self.config.output_dir) / "malaria_model.pt"
...
def main():
    ...
    print("Class Mapping: 0=Negative (Uninfected), 1=Positive (Parasitized)\n")
